...
def discover_stage(stage) -> dict:
    ...
    for prim in stage.Traverse():
        ...
        if role == "emitter":
            ...
            authored_enabled = bool(_required(prim, "opengrow:enabled"))
            effective_visibility = UsdGeom.Imageable(prim).ComputeVisibility()
            visible = effective_visibility != UsdGeom.Tokens.invisible
            record.update({
